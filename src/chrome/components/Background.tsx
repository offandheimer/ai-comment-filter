    ...
    const findCommentSection = () => {
      ...
      for (const selector of selectors) {
        ...
        if (element) {
          ...
          const headerElement = document.querySelector('ytd-comments-header-renderer.style-scope.ytd-item-section-renderer');
          if (headerElement) {
            const headerRect = headerElement.getBoundingClientRect();
            const headerBottom = headerRect.top + window.scrollY + headerRect.height;
